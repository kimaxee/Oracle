--문13
--계속	.id 칼럼 추가	number(5)                             ex.   alter table tottenham_squad add id number(5) default 0;           
--      중복안되게 id에 번호 부여하기 하나하나 업데이트
...
alter table tottenham_squad add id number(5) default 0;                         -- .id 칼럼 추가	number(5)
