--문15
--계속	칼럼 추가          WeeklyWage	number(9)	주급	ALTER TABLE tottenham_squad add WeeklyWage number(9) default 0 not null;				    
--                        YearlySalary	number(9)	연봉	ALTER TABLE tottenham_squad add YearlySalary number(9) default 0 not null;				 
...
alter table tottenham_squad add weeklywage number(9) default 0 not null;        -- 칼럼 추가 WeeklyWage	number(9) 주급
...
update tottenham_squad set weeklywage = 2500000 where id = 3;                   --      하나하나 업데이트
...
update tottenham_squad set yearlysalary = 130000000 where id = 3;               --      하나하나 업데이트
