--문19
--계속	선수단 정보 중 등번호, 이름, 일급 표시 (일급은 주급을 7로 나누면 됨)             select no,name,weeklywage/7 일급 from tottenham_squad;         참고. p.156
...
select no, name, weeklywage/7 일급 from tottenham_squad;                         --선수단 정보 중 등번호, 이름, 일급 표시 (일급은 주급을 7로 나누면 됨)
