--문24
--//            선수단 정보 중 이름에 '손' 이 들어간거 출력              select * from tottenham_squad where name like '%손%'
--              선수단 정보 중 이름에 '탄' 이 들어간거 출력              union                   참고. p.119
--              위 둘을 합쳐서 출력하기                                select * from tottenham_squad where name like '%탄%';       
...
-- alter table tottenham_squad add injury char(1);                                --문23  칼럼 추가 // 부상
...
select * from tottenham_squad where name like '%손%' union select * from tottenham_squad where name like '%탄%';  -- 선수단 정보 중 이름에 '손' 이 들어간거 출력, 선수단 정보 중 이름에 '탄' 가 들어간거 출력 위 둘을 합쳐서 출력하기
