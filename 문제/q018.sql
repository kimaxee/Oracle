--문18
--계속	선수단 정보 중 등번호, 이름, 주급만 뽑아보기. 주급 칼럼명은 한글로 표시              select no,name,weeklywage as "주급" from tottenham_squad;				참고. p.86
...
select no,name,weeklywage as "주급" from tottenham_squad;                        --선수단 정보 중 등번호, 이름, 주급만 뽑아보기. 주급 칼럼명은 한글로 표시  (세가지 방식 모두 같음)
