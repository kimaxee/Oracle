--문7
--계속	특정 번호의 선수의 이름을 수정하기		
--ex.	update tottenham_squad set name = '로드리고밴탄쿠르' where no=30;					
...
update tottenham_squad set name = '로드리고밴탄쿠르' where no=30; -- ※where no=30 조건을 넣지 않으면 전체 선수이름이 변경됨
