--문22
--//	선수단 정보 중 등번호,이름을 출력 - 조건은 주급이 얼마는 아니고 연봉이 얼마 이상인 선수만 출력    참고:	  !=
...
select no, name from tottenham_squad where weeklywage != 2800000 and yearlysalary >= 120000000;    --선수단 정보 중 등번호,이름을 출력 - 조건은 주급이 얼마는 아니고 연봉이 얼마 이상인 선수만 출력
